...
public final class Locators {
    ...
    @Getter private static final String BASE_PRODUCT="//input[@id='email']";
    ...
    @Getter private static final String BASE_RADIO="//mat-table[@role='table']/mat-row/mat-cell[@role='cell' and contains(text(),'%s')]/preceding-sibling::mat-cell/mat-radio-button";
