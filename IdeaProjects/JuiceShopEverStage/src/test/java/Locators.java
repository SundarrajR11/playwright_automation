...
public final class Locators {
    ...
    @Getter private static final String BASE_BUTTON="//span[normalize-space(text())='%s']//ancestor::button";
    ...
    @Getter private static final String BUTTON_ME_WANT_IT="//div[@role='dialog']//descendant::a[normalize-space(text())='Me want it!']";
    ...
    @Getter private static final String BASE_RADIOBUTTON="//mat-table[@role='table']/mat-row/mat-cell[@role='cell' and normalize-space(text())='%s']/preceding-sibling::mat-cell/mat-radio-button";
